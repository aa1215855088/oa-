...
var demoData = {
	...
	formList: [
		{ "form.id": 1, "form.title": "设备采购单-管理员-20100501 ", "form.applicant.name": "管理员", "form.applyTime": "2010-05-01 09:30", "form.status": "审批中" },
		{ "form.id": 1, "form.title": "出车申请单-张雪-20100512 ", "form.applicant.name": "张雪", "form.applyTime": "2010-05-12 09:30", "form.status": "未通过" },
		{ "form.id": 1, "form.title": "领款单-李明-20100516 ", "form.applicant.name": "李明", "form.applyTime": "2010-05-16 09:30", "form.status": "已通过" }
	],
	approveInfoList: [
	...
	forumList: [
		{ "forum.name": "常见问题", "forum.description": "把常见的问题随时记录下来，供后来人参考。积累经验。", "forum.topicCount": 56, "forum.articleCount": 107, "forum.lastTopic.title": "OA是什么？ ", "forum.lastTopic.author.name": "管理员", "forum.lastTopic.postTime": "2010-06-12 17:47"  },
	...
	topicList: [
		{ "topic.type": "top", "topic.title": "项目管理", "topic.replyCount": 35 },
		{ "topic.type": "comm", "topic.title": "审批流转是干什么用的？ ", "topic.replyCount": 33 },
		{ "topic.type": "hot", "topic.title": "FAQ", "topic.replyCount": 75 },
		{ "topic.type": "comm","topic.title": "我的邮箱为什么不能正常使用？", "topic.replyCount": 998 },
		{ "topic.type": "comm","topic.title": "流程类别是干什么用的？", "topic.replyCount": 17 }
	],
	articleList: [
		{ "article.title": "项目管理", "article.content": "项目管理", "article.floor": "楼主" },
		{ "article.title": "审批流转是干什么用的？ ", "article.content": "审批流转是干什么用的？", "article.floor": "1楼" },
		{ "article.title": "我的邮箱为什么不能正常使用？", "article.content": "我的邮箱为什么不能正常使用？", "article.floor": "2楼" },
		{ "article.title": "流程类别是干什么用的？", "article.content": "流程类别是干什么用的？", "article.floor": "3楼" }
	],
    xxList: []
};
